                ...
                <CardContent>
                    <div className="space-y-4">
                        ...
                        <Button disabled={isSubmitting} className="w-full" type="submit">
                            Sign Up  {isSubmitting && <FaSpinner className="animate-spin ml-4" />}
                        </Button>
                        <CardDescription className=" w-full flex justify-center">If you account already so <Link href='/auth/sign-in' className=" font-bold text-blue-950 ml-2" >Sign In</Link></CardDescription>
                    </div>
                </CardContent>
            </Card>
            </form>
